...
MatchTemplatePanelParent::MatchTemplatePanelParent( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : JobPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText699111 = new wxStaticText( ExpertPanel, wxID_ANY, wxT("Crop images > 4096?"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText699111->Wrap( -1 );
	fgSizer1->Add( m_staticText699111, 0, wxALL, 5 );

	wxBoxSizer* bSizer26511;
	bSizer26511 = new wxBoxSizer( wxHORIZONTAL );

	UseFastFFTAndCropRadioYes = new wxRadioButton( ExpertPanel, wxID_ANY, wxT("Yes"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	bSizer26511->Add( UseFastFFTAndCropRadioYes, 0, wxALL, 5 );

	UseFastFFTAndCropRadioNo = new wxRadioButton( ExpertPanel, wxID_ANY, wxT("No"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer26511->Add( UseFastFFTAndCropRadioNo, 0, wxALL, 5 );
